...
class ContactDocument(models.Model):
    ...
    partner_id = fields.Many2one('res.partner', invisible=1,
                                      copy=False,
                                      help='Specify the customer name.')
    pdoc_attachment_ids = fields.Many2many('ir.attachment',
                                          'pdoc_attach_rel',
                                          'pdoc_id', 'pattach_id3',
                                          string="Attachment",
    ...
    document_type_id = fields.Many2one('partner.document.type',
    ...
    notification_to = fields.Many2one('res.partner','Notification To')
